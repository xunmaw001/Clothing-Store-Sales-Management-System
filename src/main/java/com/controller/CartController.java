    ...
    public R info(@PathVariable("id") Long id, HttpServletRequest request){
        ...
        if(cart !=null){
            ...
            BeanUtils.copyProperties( cart , view );//把实体数据重构到view中
                ...
                //级联表
                FuzhuangEntity fuzhuang = fuzhuangService.selectById(cart.getFuzhuangId());
                if(fuzhuang != null){
    ...
    */
    ...
    public R save(@RequestBody CartEntity cart, HttpServletRequest request){
        ...
        Wrapper<CartEntity> queryWrapper = new EntityWrapper<CartEntity>()
            ...
            .eq("fuzhuang_id", cart.getFuzhuangId())
...
//                            cartEntity.setFuzhuangId(Integer.valueOf(data.get(0)));   //服装 要改的
