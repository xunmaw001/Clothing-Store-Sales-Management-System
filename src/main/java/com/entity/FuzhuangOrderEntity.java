...
public class FuzhuangOrderEntity<T> implements Serializable {
     ...
     * 审核状态
     */
    @TableField(value = "fuzhuang_order_yesno_types")

    private Integer fuzhuangOrderYesnoTypes;


    /**
     * 审核意见
     */
    @TableField(value = "fuzhuang_order_yesno_text")

    private String fuzhuangOrderYesnoText;
	 ...
	 * 设置：审核状态
	 */
    public Integer getFuzhuangOrderYesnoTypes() {
        return fuzhuangOrderYesnoTypes;
    }
    /**
	 * 获取：审核状态
	 */

    public void setFuzhuangOrderYesnoTypes(Integer fuzhuangOrderYesnoTypes) {
        this.fuzhuangOrderYesnoTypes = fuzhuangOrderYesnoTypes;
    }
    /**
	 * 设置：审核意见
	 */
    public String getFuzhuangOrderYesnoText() {
        return fuzhuangOrderYesnoText;
    }
    /**
	 * 获取：审核意见
	 */

    public void setFuzhuangOrderYesnoText(String fuzhuangOrderYesnoText) {
        this.fuzhuangOrderYesnoText = fuzhuangOrderYesnoText;
    }
    /**
	 * 设置：支付类型
	 */
    ...
    public String toString() {
        return "FuzhuangOrder{" +
            ...
            ", fuzhuangOrderYesnoTypes=" + fuzhuangOrderYesnoTypes +
            ", fuzhuangOrderYesnoText=" + fuzhuangOrderYesnoText +
