 ...
 */
@TableName("fuzhuang_collection")
public class FuzhuangCollectionView extends FuzhuangCollectionEntity implements Serializable {
    private static final long serialVersionUID = 1L;

		/**
		* 类型的值
		*/
		private String fuzhuangCollectionValue;
	...
	public FuzhuangCollectionView() {

	}

	public FuzhuangCollectionView(FuzhuangCollectionEntity fuzhuangCollectionEntity) {
		try {
			BeanUtils.copyProperties(this, fuzhuangCollectionEntity);
			...
			* 获取： 类型的值
			*/
			public String getFuzhuangCollectionValue() {
				return fuzhuangCollectionValue;
			}
			/**
			* 设置： 类型的值
			*/
			public void setFuzhuangCollectionValue(String fuzhuangCollectionValue) {
				this.fuzhuangCollectionValue = fuzhuangCollectionValue;
			}
