...
public class FuzhuangCommentbackEntity<T> implements Serializable {
    private static final long serialVersionUID = 1L;


	public FuzhuangCommentbackEntity() {

	}

	public FuzhuangCommentbackEntity(T t) {
		try {
     ...
     * 评价内容
     */
    @TableField(value = "fuzhuang_commentback_text")
    ...
    public String toString() {
        return "FuzhuangCommentback{" +
            "id=" + id +
            ", fuzhuangId=" + fuzhuangId +
            ", yonghuId=" + yonghuId +
            ", fuzhuangCommentbackText=" + fuzhuangCommentbackText +
