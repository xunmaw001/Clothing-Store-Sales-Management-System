    ...
    <ul class="layui-nav layui-nav-tree">
				...
				<div class="right-container">
					<form class="layui-form" lay-filter="myForm">
						...
						<div class="layui-form-item">
							...
							<div class="layui-input-block">
								<input type="text" style="width: 500px" name="yuangongName" id="yuangongName" lay-verify="required" placeholder="员工姓名" autocomplete="off" class="layui-input">
							</div>
						</div>
						...
						<div class="layui-form-item">
							...
							<div class="layui-input-block">
								<input type="text" style="width: 500px" name="yuangongPhone" id="yuangongPhone"  lay-verify="required|phone"   placeholder="员工手机号" autocomplete="off" class="layui-input">
							</div>
						</div>
						...
						<div class="layui-form-item">
							...
							<div class="layui-input-block">
								<input type="text" style="width: 500px" name="yuangongIdNumber" id="yuangongIdNumber"  lay-verify="required|identity"   placeholder="员工身份证号" autocomplete="off" class="layui-input">
							</div>
						</div>
						...
						<div class="layui-form-item">
							<div class="layui-input-block">
								<img id="yuangongPhotoImg"
									 ...
									 src="../../img/avator.png">
								<input type="hidden" id="yuangongPhoto" name="yuangongPhoto"/>
							</div>
						</div>
						...
						<div class="layui-form-item">
							...
							<div class="layui-input-block">
								<input type="text" style="width: 500px" name="yuangongEmail" id="yuangongEmail"  lay-verify="required|email"   placeholder="电子邮箱" autocomplete="off" class="layui-input">
							</div>
						</div>
		...
		<script>
            ...
            layui.use(['layer', 'element', 'carousel', 'http', 'jquery', 'form', 'upload', 'laydate'], function () {
                ...
                http.request(`yuangong/session`, 'get', {}, function (data) {
                    // 表单赋值
                    form.val("myForm", data.data);
					jquery("#yuangongPhotoImg").attr("src", data.data.yuangongPhoto);
                });
