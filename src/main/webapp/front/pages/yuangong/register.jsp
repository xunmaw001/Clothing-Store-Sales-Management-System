            ...
            <article>
              <form class="layui-form login-form" lay-filter="register">
                ...
                <div class="layui-form-item layui-form-text input">
                  ...
                  <div class="layui-form-item layui-form-text input">
                    <div class="layui-inline" >
                        <span style="margin-top: 8px;float: left">员工姓名:</span>
                        <div class="layui-input-inline">
                            <input type="text" name="yuangongName" id="yuangongName"  placeholder="员工姓名"  lay-verify="required" autocomplete="off" class="layui-input" style="width: 600px;">
                        </div>
                    </div>
                </div>
<!-- 手机号 -->
                <div class="layui-form-item layui-form-text input">
                    <div class="layui-inline" >
                        <span style="margin-top: 8px;float: left">员工手机号:</span>
                        <div class="layui-input-inline">
                            <input type="text" name="yuangongPhone" id="yuangongPhone"  lay-verify="phone|required"   placeholder="员工手机号" autocomplete="off" class="layui-input" style="width: 400px;">
                        </div>
                    </div>
                </div>
  <!-- 身份证号 -->
                <div class="layui-form-item layui-form-text input">
                    <div class="layui-inline" >
                        <span style="margin-top: 8px;float: left">员工身份证号:</span>
                        <div class="layui-input-inline">
                            <input type="text" name="yuangongIdNumber" id="yuangongIdNumber"  lay-verify="identity|required"   placeholder="员工身份证号" autocomplete="off" class="layui-input" style="width: 400px;">
                        </div>
                    </div>
                </div>
                  <div class="layui-form-item layui-form-text input">
...
<!-- 邮箱 -->
                <div class="layui-form-item layui-form-text input">
                    <div class="layui-inline" >
                        ...
                        <div class="layui-input-inline">
                            <input type="text" name="yuangongEmail" id="yuangongEmail"  lay-verify="email|required"   placeholder="电子邮箱" autocomplete="off" class="layui-input" style="width: 400px;">
                        </div>
                    </div>
                </div>
