                    ...
                    <form class="layui-form" lay-filter="myForm">
                      ...
                      <div class="layui-inline" style="margin-bottom: 10px;">
                          ...
                          <div class="layui-input-inline">
                              <input type="text" name="yuangongName" id="yuangongName" placeholder="员工姓名" autocomplete="off" class="layui-input">
                          </div>
                      </div>
...
<script>
    ...
    // 当前表的字典表
        ...
        function pageList() {
            ...
            if (jquery('#yuangongName').val() != null && jquery('#yuangongName').val() != "" && jquery('#yuangongName').val() != "null" ) {
                param['yuangongName'] = jquery('#yuangongName').val();
            }
