...
var centerMenu = [
    ...
    ,{
        name: '服装收藏',
        url: '../fuzhuangCollection/list.jsp'
    }
    ,{
        name: '服装订单',
        url: '../fuzhuangOrder/list.jsp'
    }
...
var adminurl =  "http://localhost:8080/fuzhuangdianxiaoshou/jsp/login.jsp";
