                    ...
                    <div class="widget-area-2 lochana-box-shadow">
                        ...
                        <form id="addOrUpdateForm">
                            ...
                            <!-- 当前表的字段 -->
                                    ...
                                    <div class="form-group col-md-6 dengjiTypesDiv">
                                        <label>会员等级</label>
                                        <select style="width: 450px" id="dengjiTypesSelect" name="dengjiTypes" class="form-control">
                                        </select>
                                    </div>
...
<script>
    ...
    // 查询列表
        ...
        function dengjiTypesSelect() {
            //填充下拉框选项
            http("dictionary/page?page=1&limit=100&sort=&order=&dicCode=dengji_types", "GET", {}, (res) => {
                if(res.code == 0){
                    dengjiTypesOptions = res.data.list;
                }
            });
        }
        <!-- 查询级联表的所有列表 -->
    ...
    <!-- 初始化当前表的下拉框 -->
        ...
        function initializationDengjitypesSelect(){
            var dengjiTypesSelect = document.getElementById('dengjiTypesSelect');
            if(dengjiTypesSelect != null && dengjiTypesOptions != null  && dengjiTypesOptions.length > 0 ){
                for (var i = 0; i < dengjiTypesOptions.length; i++) {
                    dengjiTypesSelect.add(new Option(dengjiTypesOptions[i].indexName,dengjiTypesOptions[i].codeIndex));
                }
            }
        }
    ...
    function setSelectOption() {
        ...
        if(dengjiTypesSelect != null && dengjiTypesOptions != null  && dengjiTypesOptions.length > 0 ) {
            for (var i = 0; i < dengjiTypesOptions.length; i++) {
                if (dengjiTypesOptions[i].codeIndex == ruleForm.dengjiTypes) {//下拉框value对比,如果一致就赋值汉字
                        dengjiTypesSelect.options[i].selected = true;
                }
            }
        }
        <!--  级联表的下拉框回显  -->
    ...
    $(document).ready(function () {
        ...
        // 初始化下拉框
            ...
            initializationDengjitypesSelect();
            <!--  初始化级联表的下拉框  -->
    ...
    function readonly() {
        if (window.sessionStorage.getItem('role') == '管理员') {
            ...
            $('#dengjiTypesSelect').attr('style', 'pointer-events:none;width:450px;');
        }
