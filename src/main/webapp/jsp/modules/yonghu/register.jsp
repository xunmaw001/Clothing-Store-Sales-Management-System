...
<body style="background-image:url('/fuzhuangdianxiaoshou/img/back-img-bg.jpg') !important;background-size:cover;">
<!-- Pre Loader -->
<div class="loading">
    <div class="spinner">
                        ...
                        <form id="register">
                            <div class="form-row">
                                ...
                                <div class="form-group col-md-12">
                                   ...
                                   <%--<div class="form-group col-md-12">
                                       <label>会员等级</label>
                                       <select id="dengjiTypesSelect" name="dengjiTypes" class="form-control">
                                       </select>
                                   </div>--%>
                                <div class="form-group col-md-12">
