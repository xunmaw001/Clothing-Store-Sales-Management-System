                    ...
                    <div class="widget-area-2 lochana-box-shadow">
                        ...
                        <form id="addOrUpdateForm">
                            ...
                            <!-- 当前表的字段 -->
                                    ...
                                    <div class="form-group col-md-6 yuangongNameDiv">
                                        <label>员工姓名</label>
                                        <input style="width: 450px" id="yuangongName" name="yuangongName" class="form-control"
                                               placeholder="员工姓名">
                                    </div>
                                    <div class="form-group col-md-6 yuangongPhoneDiv">
                                        <label>员工手机号</label>
                                    ...
                                    <div class="form-group col-md-6 yuangongIdNumberDiv">
                                        <label>员工身份证号</label>
                                        <input style="width: 450px" id="yuangongIdNumber" name="yuangongIdNumber" class="form-control"
                                               onchange="yuangongIdNumberChickValue(this)"  placeholder="员工身份证号">
                                    </div>
                                    <div class="form-group col-md-6 yuangongPhotoDiv">
                                        <label>员工头像</label>
                                    ...
                                    <div class="form-group col-md-6 yuangongEmailDiv">
                                        <label>电子邮箱</label>
                                        <input style="width: 450px" id="yuangongEmail" name="yuangongEmail" class="form-control"
                                               placeholder="电子邮箱">
                                    </div>
    ...
    function validform() {
        return $("#addOrUpdateForm").validate({
            ...
            messages: {
                ...
                yuangongPhoto: "员工头像不能为空",
                sexTypes: "性别不能为空",
                yuangongEmail: "电子邮箱不能为空",
            }
        }).form();
    }
